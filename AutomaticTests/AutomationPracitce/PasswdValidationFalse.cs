...
{
    [TestFixture]
    public class PasswdValidationFalse
    {
        ...
        [Test]
        public void ThePasswdValidationFalseTest()
        {
            ...
            driver.FindElement(By.Id("passwd")).SendKeys("asd");
            ...
            try
            {
              Assert.AreEqual("passwd", driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Create an account'])[1]/following::b[1]")).Text);            
            }
