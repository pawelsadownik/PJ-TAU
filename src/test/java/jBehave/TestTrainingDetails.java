...
@AsParameters
public class  TestTrainingDetails extends AuditableEntity {
    ...
    public TestTrainingDetails(int id, String name, List<String> excersises, int duration,
